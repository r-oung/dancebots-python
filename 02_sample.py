...
# Add some lights
light = Light()
light.blink([0,1,0,1,0,1,0,1], 5) # each element in the list represents a single LED (0 is OFF, 1 is ON), blink for 5 beats
...
db.load("./samples/dance_demo.mp3") # load music file
